...
private:
    ...
    static constexpr int m_minChainLength = mining::CPU_MIN_CHAIN_LENGTH;
    static constexpr int m_maxGap = mining::CPU_MAX_PRIME_GAP;
    ...
    std::atomic<uint64_t> m_range_searched{0};
